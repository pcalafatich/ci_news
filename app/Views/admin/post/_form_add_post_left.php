<div class="box">
    <!-- AGREGAR ARTICULO: TITULO DETALLES DE PUBLICACION -->
    <div class="box-header with-border">
        <div class="left">
            <h3 class="box-title"><?= trans('post_details'); ?></h3>
        </div>
    </div>
    <!-- INICIO FORMULARIO AGREGAR ARTICULO -->
    <div class="box-body">
        <!-- TITULO DEL ARTICULO -->
        ...
        <!-- MOSTRAR COLUMNA DERECHA EN ARTICULO -->
        <div class="form-group">
            <div class="row">
                <div class="col-sm-4 col-xs-12">
        ...
        <?php endif; ?>
        <!-- AGREGAR A SOLO PARA USUARIOS RECOMENDADOS -->
        <div class="form-group">
            <div class="row">
                <div class="col-md-4 col-sm-12">
    ...
    <!-- FIN DORMULARIO AGREGAR ARTICULO -->
</div>

<script>
    var postType = "<?= $postType; ?>";
    var textSelectResult = "<?= clrQuotes(trans("select_a_result")); ?>";
    //notificar antes de cerrar la página
